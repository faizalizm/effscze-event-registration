  ...
  <body>
    <div class="global-container">
      <?php
        ...
        $findUserCommand = "SELECT * FROM user WHERE userid ='$userid'";
        $findUserExecute = mysqli_query($connect, $findUserCommand) or die("Couldn't connect to database");

        $row = mysqli_fetch_array($findUserExecute, MYSQLI_BOTH);
      ?>
      <header>
        <a href="index.php">
          <img
      ...
      <div class="div1" id="scroll">
        ...
        <div class="tab-link" id="scroll-to-view">
          <div class="tab">
            <h4>
              My Profile - <span class="highlight-text">Summary</span>
            </h4>
          </div>
        </div> 
        ...
        <div class="joined-event">
            ...
            <?php
              if(mysqli_num_rows($findEventExecute) > 0){
                ...
                echo "
                <a href='events.php' class='browse event-text'><h5>No registered events yet.</h5><h5>Click here to browse events</h5></a>";
            ?>
    ...
    <div class="no-session">
      ...
      <h6>This area is user-only. No session exist or session is expired. <a href='sign.php' class="gradient-text">Please log in again</a></h6>
    </div>
    <?php
      }
    ?>
